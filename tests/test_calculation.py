...
def test_calculate_division_by_zero():
    with pytest.raises(OperationError, match="Division by zero is not allowed."):
        Calculation(operation='Division', operand1=Decimal('5.0'), operand2=Decimal('0.0'))
...
def test_calculate_integer_division():
    calc = Calculation(operation='IntegerDivision', operand1=Decimal('5.0'), operand2=Decimal('3.0'))
...
def test_calculate_integer_division_by_zero():
    with pytest.raises(OperationError, match="Integer division by zero is not allowed."):
        Calculation(operation='IntegerDivision', operand1=Decimal('5.0'), operand2=Decimal('0.0'))
...
def test_repr_representation():
    ...
    calc = Calculation(operation="Addition", operand1=Decimal("2"), operand2=Decimal("3"))
    expected_repr = f"Calculation(operation='Addition', operand1=2, operand2=3, result=5, timestamp='{calc.timestamp.isoformat()}')"
